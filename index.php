...
<div id="wrapper">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/02.jpg" width="861" height="379"  alt="" /></li>
    ...
    <div id="featured">
        <div id="items">
            <div class="item"> <a href="menu.html"><img src="xres/images/01_featured.jpg" alt="" /></a>
            <h3><a href="menu.html">Weekly Specials</a></h3>
            <p><a href="menu.html"><strong>New Signature Dishes</strong><br />
			Come in and experience<br /> Chef Cat's brand
			new<br /> Specials' today!</a></p>  
            </div>
            <div class="item"> <a href="facilities.html"><img src="xres/images/02_featured.jpg" alt="" /></a>
            <h3><a href="facilities.html">Lodging Available</a></h3>
            <p><a href="facilities.html"><strong>RCF Swagat Guest House, Kihim</strong><br />
			Spend a relaxing evening on Kihim Beach. </a></p>  
			</div>
        </div>
